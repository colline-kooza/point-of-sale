...
export default async function LoginPage() {
  ...
  return (
    ...
    <div className="container relative min-h-[600px] flex-col items-center justify-center md:grid lg:max-w-none mt-[8rem] lg:mt-0 md:mt-0 lg:grid-cols-2 lg:px-0 bg-1">
      ...
      <img className="blur-[0px] object-cover w-full h-full rounded-sm" src="https://media.istockphoto.com/id/1808058549/video/woman-barista-and-coffee-with-thumbs-up-thank-you-and-hospitality-success-customer-services.jpg?s=640x640&k=20&c=CO6kvFMAppR-QrF7DKdUO4pZm2xg3gGeXVs-4D7bQRA=" alt="" />
      </div>
